...
ACLOCAL = ${SHELL} /tmp/toilet/.auto/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AUTOCONF = ${SHELL} /tmp/toilet/.auto/missing --run autoconf
AUTOHEADER = ${SHELL} /tmp/toilet/.auto/missing --run autoheader
AUTOMAKE = ${SHELL} /tmp/toilet/.auto/missing --run automake-1.11
AWK = gawk
CACA_CFLAGS =  
CACA_LIBS = -lcaca  
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /tmp/toilet/.auto/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = toilet
PACKAGE_BUGREPORT = 
...
STRIP = 
VERSION = 0.3
abs_builddir = /tmp/toilet
abs_srcdir = /tmp/toilet
abs_top_builddir = /tmp/toilet
abs_top_srcdir = /tmp/toilet
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /tmp/toilet/.auto/install-sh
